...
//
//	private Ads ads = new YandexDirectImpl(AuthTokens.fake()).banners();
//
//	@Test
...
//
//		List<BannerInfo> bannersInfos = ads.get(param);
//
...
//
//		ads.stop(banner_ids.subList(0, 1));
//	}
//
//	@Test
...
//
//		List<Long> created_banner_ids = ads.create(items);
//
